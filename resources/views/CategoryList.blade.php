    ...
    <div class="col-md-12 col-xxl-3">
      <div class="card h-md-100 ecommerce-card-min-width">
        <div class="card-header pb-0">
          <h6 class="mb-0 mt-2 d-flex align-items-center">Category</h6>
              ...
              <table class="table table-bordered table-striped fs--1">
                ...
                <tbody class="list">
                  ...
                  <tr>
                    ...
                    {{-- <td class="age"><a href="{{ url('/test',$y->id) }}" class="btn btn-primary"><i class="far fa-clone"></i></a></td> --}}
                    <td class="age"><a onclick="deletedata('{{ url('/category/delete',$y->id) }}','Delete Category..')" class="btn btn-danger"><i class="far fa-trash-alt"></i></a></td>
                  </tr>
