<x-app-layout>
        ...
        const renderCheckout = () => {
            ...
            for (let id in cart) {
                ...
                checkoutBody.innerHTML += `
                    <tr data-id="${id}">
                        <td>${item.name}</td>
                        <td><input type="number" class="form-control form-control-sm price-input" value="${item.price.toFixed(2)}" min="0" step="0.01"></td>
                        <td><input type="number" class="form-control form-control-sm qty-input" value="${item.quantity}" min="1" step="1"></td>
    ...
    try {
        const response = await fetch(checkoutForm.action, {
            ...
            body: JSON.stringify({
                cart_data: Object.values(cart) // send as array
            })
        });
